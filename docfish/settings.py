"""
Django settings for docfish project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'docfish.apps.base.context_processors.domain_processor', #custom context processor
                'docfish.apps.base.context_processors.disqus_processor', #custom context processor
            ],
        },
    },
]
...
WSGI_APPLICATION = 'docfish.wsgi.application'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'docfish.apps.users.views.redirect_if_no_refresh_token',
...
# Bogus secret key.
try:
    from docfish.secrets import *
except ImportError:
    from docfish.bogus_secrets import *

# Local settings
try:
    from docfish.local_settings import *
except ImportError:
    pass
