...
def import_structures(structures,collection):
    '''import structures will import structures (export from docfish standard with som-tools)
...
def update_entity(entity,images=None,texts=None):
    ...
    :param entity: the docfish.apps.main.models Entity
    :param images: a list of images, from the docfish structure
